...
/**
 * Transport for idealista's search pages.
 *
 ...
 * Measured against idealista.com, .it and .pt, the challenge clears in four to six seconds.
 *
 ...
 *
 * `main#main-content` wraps the result list on every idealista domain and is equally present on a
 ...
 *
 * @param {string} url the job's search url, sorted by date already
