 ...
 *
 * Supports the legacy single `home_address` object shape by wrapping it in a
 * one-element list, so no settings-blob migration is needed.
 * ponytail: read-time shim, drop after users re-save addresses
 *
 * @param {Record<string, any>} settings
 * @returns {import('../../types/listing.js').HomeAddress[]}
 */
