...
export const queryListings = ({
  ...
  if (statusFilter === 'none') {
    ...
    ['applied', 'invited', 'visited', 'documents_sent', 'accepted', 'rejected', 'not_invited'].includes(
...
export const setListingStatus = (id, status) => {
  if (!id) return 0;
  const allowed = ['applied', 'invited', 'visited', 'documents_sent', 'accepted', 'rejected', 'not_invited'];
