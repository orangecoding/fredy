...
export const queryListings = ({
  ...
  // Known application stages use equality on the JSON status field; 'none' matches NULL.
  ...
  } else if (typeof statusFilter === 'string' && normalizeListingStatus(statusFilter) != null) {
    params.statusValue = normalizeListingStatus(statusFilter);
...
export const setListingStatus = (id, status) => {
  ...
  if (status != null && normalized == null) {
