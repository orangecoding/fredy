...
export function buildSchedule({
  ...
  return {
    ...
    months,
    // The yearly rollup travels with the schedule so the charts do not have to derive it. They
    // used to call aggregateByYear() in the browser, which meant the frontend carried a copy of
    // this module; there is only one implementation now, and it is this one.
    years: aggregateByYear(months),
    payoffMonths,
    totalInterest,
    totalPaid,
    restschuld,
