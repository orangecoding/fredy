 ...
 *
 * Copied from `ui/src/services/jobs/providerUrl.js` rather than shared: the frontend may not
 * import out of lib/. `test/ui/providerUrlCopyInSync.test.js` is what stops the two drifting.
 */
 ...
 */
export function hostsOf(provider) {
