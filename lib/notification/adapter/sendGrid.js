...
export const config = {
  ...
  fields: {
    ...
    from: {
      ...
      label: 'Sender Email',
      description:
        'The email address from which Fredy sends email. Beware, this email address needs to be verified by Sendgrid. ' +
        'Write it as "Fredy <you@example.com>" to get a display name in the inbox.',
    },
    templateId: {
      type: 'text',
      label: 'Template Id',
