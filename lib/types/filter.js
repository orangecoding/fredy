...
/*
 * The commute filter lives in `lib/utils/commuteBudget.js` rather than here, next to the code that
 * normalises and applies it: it is the one filter with behaviour attached, not just a shape.
 */
