 ...
 * @property {(url: string, browser?: any) => Promise<any[]>} [getListings] Optional override to fetch listings. Receives the shared browser instance when requiresBrowser is enabled.
 * @property {boolean} [requiresBrowser] Whether this provider needs the shared browser even when it implements getListings.
