...
import { PORTALS, portalOf, requirePortal } from '../services/idealista/portal.js';
...
export const metaInformation = {
  countries: ['es', 'it', 'pt'],
  countryOf,
  // One portal on three domains, so a job url may name any of them. Checking a pasted url against
  // `baseUrl` alone refused every Italian and Portuguese search the provider can perfectly well run.
