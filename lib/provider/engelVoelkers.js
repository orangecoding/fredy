...
async function fetchDetails(listing, browser) {
  try {
    ...
    return {
      ...
      publishedAt: publicationDate(detail.publishedAt) ?? listing.publishedAt,
...
const config = {
  ...
  // ?price.min=500&price.max=1000 - dotted names, not nested objects.
  priceRangeParams: { min: 'price.min', max: 'price.max' },
