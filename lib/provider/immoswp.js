...
const config = {
  ...
  // ?pf=500&pt=1000 - price from, price to. The neighbouring rf/rt, sf/st and psf/pst pairs are
  // rooms, living space and plot space in the same shorthand.
  priceRangeParams: { min: 'pf', max: 'pt' },
