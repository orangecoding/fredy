...
/**
 * Reads living space and room count from the detail page's attribute list.
 *
 ...
 * @returns {{detailSize: string|null, detailRooms: string|null}}
 */
...
async function enrichListingFromDetails(listing, browser) {
  ...
  try {
    ...
    const { detailAddress, detailDescription, detailSize, detailRooms } = extractDetailFromHtml(html);
