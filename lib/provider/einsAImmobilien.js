...
const config = {
  ...
  // 1a-immobilienmarkt keeps the whole search server side behind a `data_hash`, so a price filter
  // leaves no trace in the URL at all. Nothing to read, rather than nothing checked.
