...
const config = {
  ...
  // Immowelt is a React SPA; the grid selector can take >60 s to appear after
  // CloakBrowser's humanise delays, so we allow a longer navigation budget.
  puppeteerOptions: { puppeteerTimeout: 90_000 },
  crawlFields: {
    id: 'a@href',
