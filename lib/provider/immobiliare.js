...
const config = {
  ...
  // The detail reads ride the app api, so they are paced rather than fired as fast as the network
  // allows: a run finding a hundred new listings would otherwise send a hundred requests at once.
