...
jobRouter.get('/defaultCustomFields', async (req, res) => {
  res.body = config.defaultCustomFields || [];
  res.send();
});
...
jobRouter.post('/', async (req, res) => {
  const { provider, notificationAdapter, name, blacklist = [], jobId, enabled, customFields, waypoints = [] } = req.body;
  try {
