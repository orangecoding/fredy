...
/*
 * Homegate.ch provider test
 *
 * NOTE: Integration tests are skipped because Homegate uses Cloudflare protection
 * that requires a residential proxy to bypass. These unit tests verify the URL
 * helper functions work correctly.
 */

import { expect } from 'chai';
import { getPropertyTypeSlug, sanitizeLocality } from '../../lib/provider/homegate.js';

describe('#homegate URL helpers', () => {
