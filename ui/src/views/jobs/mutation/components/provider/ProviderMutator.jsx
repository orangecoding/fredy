        ...
        >
            ...
            <p>
                ...
                <Banner fullMode={false}
                        ...
                        description={<div>
                            <p>
                                If you chose Immoscout as a provider, make sure to also add the scrapingAnt apiKey to
                                the config.json.
                                (See readme)
                            </p>
                            <p>
                                Do not forget to sort the results by date before copying the url to Fredy, so that Fredy
                                always captures
