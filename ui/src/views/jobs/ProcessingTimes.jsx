...
export default function ProcessingTimes({processingTimes}) {
    ...
    return (
        <>
            <Descriptions row size="small" style={{
                ...
                {processingTimes.lastRun && (
                    <>
                        ...
                        <Descriptions.Item
                            itemKey="Next run">{format(processingTimes.lastRun + processingTimes.interval * 60000)}</Descriptions.Item>
                    </>
                )}
            </Descriptions>
